...
import { submitAreaManagerSupportTicket } from '../../services/areaManagerService';

const AreaManagerSubmitTicketScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      const result = await submitAreaManagerSupportTicket({
...
export default AreaManagerSubmitTicketScreen;
